...
export const Articles = ({ data, team }) => {
    return (
        <div className="project-card_line">
            {data.filter(project => project.class === team).map((project, index) => {
                ...
                return (
                    <article className="project-card" onClick={() => window.location.href = project.url} key={index}>
