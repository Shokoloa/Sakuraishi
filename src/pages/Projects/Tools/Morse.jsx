...
export const Morse = () => {
    ...
    function textToMorse() {
        ...
        document.getElementById('morse-input').value = morseCode;
    }
    ...
    function morseToText() {
        const inputMorse = document.getElementById('morse-input').value;
        ...
        document.getElementById('text-input').value = translatedText.toLowerCase();
    }

    async function copyMorse() {
        const binaryText = document.getElementById('morse-input').value;
        await navigator.clipboard.writeText(binaryText);
    }


    async function copyText() {
        const binaryText = document.getElementById('text-input').value;
        await navigator.clipboard.writeText(binaryText);
    }
    ...
    return (
        <section>
            ...
            <main className="slug">
                <h1>Morse</h1>
                <p>Convertisseur de morse</p>
                <hr />
                <article className="slug-desc">
                    <h1>Text vers Morse</h1>
                    <div className="auto-expand">
                        <textarea className="textare-auto" id="text-input" onInput={textToMorse} placeholder="Place text here"></textarea>
                        <div className="copy copy-text" onClick={copyText}>
                    ...
                    <h1>Morse vers Text</h1>
                    <div className="auto-expand">
                        <textarea className="textare-auto" id="morse-input" onInput={morseToText} placeholder="Place morse here"></textarea>
                        <div className="copy copy-morse" onClick={copyMorse}>
                            <span data-text-end="Copié!" data-text-initial="Copier" className="tooltip"></span>
                            <span>
                                {ClipboardSVG}
                                {CheckmarkSVG}
